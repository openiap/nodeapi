            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Signin({ username: _username, password: _password, ping: config_1.config.DoPing, agent: this.agent, version: this.version })];
                    case 1:
                        reply = _a.sent();
                        if (this.loginresolve != null) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.Signin({ jwt: _jwt, ping: config_1.config.DoPing, agent: this.agent, version: this.version })];
                    case 3:
                        reply = _a.sent();
                        if (this.loginresolve != null) {
                            this.loginresolve(reply.user);
