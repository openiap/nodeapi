...
var agent_1 = require("./proto/agent");
/**
 * OpenIAP
 */
var openiap = /** @class */ (function (_super) {
    ...
    function openiap(url, jwt) {
        ...
        if (_this.url == null || _this.url == "")
            _this.url = process.env.wsapiurl;
        return _this;
    }
    /**
    ...
    openiap.prototype.onConnectGaveUp = function (client) {
    };
    ...
    openiap.prototype.cliOnMessage = function (client, message) {
        return __awaiter(this, void 0, void 0, function () {
            var rt, we_1, document, we, data, user_1, jwt_1, error_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        we_1 = _1.WatchEvent.decode(message.data.value);
                        if (!this.watchids[we_1.id]) return [3 /*break*/, 3];
                        document = we_1.document;
                        if (typeof document === "string")
                            document = JSON.parse(document);
                        return [4 /*yield*/, this.watchids[we_1.id](we_1.operation, document)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        warn("Got watchevent for unknown id " + we_1.id);
                        _a.label = 4;
                    case 4: return [3 /*break*/, 15];
                    case 5:
                        if (!(message.command == "queueevent")) return [3 /*break*/, 14];
                        ...
                        if (!(this.queuecallbacks[we.correlationId] && (we.replyto == "" || we.replyto == null))) return [3 /*break*/, 7];
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.queuecallbacks[we.correlationId](data, user_1)];
                                        case 1:
                                            _a.sent();
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 13];
                    case 7:
                        if (!this.queues[we.queuename]) return [3 /*break*/, 12];
                        _a.label = 8;
                    case 8:
                        _a.trys.push([8, 10, , 11]);
                        return [4 /*yield*/, apiinstrumentation_1.apiinstrumentation.With("queueevent", message.traceid, message.spanid, undefined, function (span) { return __awaiter(_this, void 0, void 0, function () {
                                var s, reply2, error_4;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 4, , 5]);
                                            s = span;
                                            return [4 /*yield*/, this.queues[we.queuename](we, data, user_1, jwt_1)];
                                        case 1:
                                            reply2 = _a.sent();
                                            if (!(reply2 != null && we.replyto != null && we.replyto != "")) return [3 /*break*/, 3];
     ...
     * @returns
     */
    openiap.prototype.Signin = function (options, span) {
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, d, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        payload.priority = 2;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
     ...
     * @returns
     */
    openiap.prototype.ListCollections = function (options, priority, span) {
        if (options === void 0) { options = {}; }
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.ListCollectionsResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
     */
    openiap.prototype.DropCollection = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.connected)
     ...
     * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
     */
    openiap.prototype.CreateCollection = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result;
     ...
     * ```
     */
    openiap.prototype.Query = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload = base_1.Envelope.create({ command: "query", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.QueryResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.results)];
     ...
     * ```
     */
    openiap.prototype.FindOne = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c, array;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!this.connected)
     ...
     * ```
     */
    openiap.prototype.GetDocumentVersion = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload = base_1.Envelope.create({ command: "getdocumentversion", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.GetDocumentVersionResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.Count = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
 ...
 * ```
 */
    openiap.prototype.Distinct = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = querys_1.DistinctResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.Aggregate = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.AggregateResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.results)];
     ...
     * ```
     */
    openiap.prototype.InsertOne = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload = base_1.Envelope.create({ command: "insertone", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.InsertOneResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.result)];
     ...
     * ```
     */
    openiap.prototype.InsertMany = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.InsertManyResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.results)];
     ...
     * ```
     */
    openiap.prototype.UpdateOne = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload = base_1.Envelope.create({ command: "updateone", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.UpdateOneResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.result)];
     ...
     * ```
     */
    openiap.prototype.UpdateDocument = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.UpdateDocumentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.InsertOrUpdateOne = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.InsertOrUpdateOneResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.result)];
     ...
     * ```
     */
    openiap.prototype.InsertOrUpdateMany = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.InsertOrUpdateManyResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.results)];
     ...
     * ```
     */
    openiap.prototype.DeleteOne = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.DeleteOneResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.DeleteMany = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload = base_1.Envelope.create({ command: "deletemany", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.DeleteManyResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.affectedrows];
     ...
     * });
     */
    openiap.prototype.Watch = function (options, callback, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, i, element, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!callback)
     ...
     * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
     */
    openiap.prototype.UnWatch = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, protowrap_1.protowrap.DownloadFile(this.client, opt.id, opt.collectionname, opt.filename, opt.folder, config_1.config.SendFileHighWaterMark)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, protowrap_1.protowrap.UploadFile(this.client, opt.filename, opt.metadata, opt.jwt)];
                    case 1:
                        result = _a.sent();
     ...
     * ```
     */
    openiap.prototype.RegisterQueue = function (options, callback, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.RegisterQueueResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.RegisterExchange = function (options, callback, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.RegisterExchangeResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * ```
     */
    openiap.prototype.UnRegisterQueue = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result;
     ...
     * ```
     */
    openiap.prototype.QueueMessage = function (options, rpc, priority, span) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!this.signedin)
                    throw new Error("Not signed in to server");
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var opt, _a, message, data, payload, _b, traceId, spanId, result, error_5;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _c.trys.push([0, 5, , 6]);
                                ...
                                case 3:
                                    ...
                                    _b = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _b[0], spanId = _b[1];
                                    payload.spanid = spanId;
                                    payload.traceid = traceId;
                                    payload.priority = priority;
                                    return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
     ...
     * console.log("Pushed workitem with id " + workitem._id);
     */
    openiap.prototype.PushWorkitem = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.PushWorkitemResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     */
    openiap.prototype.PushWorkitems = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c, i, wi;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!this.connected)
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.PushWorkitemsResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        if (result.workitems) {
     ...
     */
    openiap.prototype.PopWorkitem = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.PopWorkitemResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        if (result && result.workitem && result.workitem.payload) {
     ...
     * ```
     */
    openiap.prototype.UpdateWorkitem = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.UpdateWorkitemResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        if (result && result.workitem && result.workitem.payload) {
     ...
     * ```
     */
    openiap.prototype.DeleteWorkitem = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.connected)
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.AddWorkItemQueue = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new AddWorkItemQueueDefaults(), options);
                        message = _1.AddWorkItemQueueRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.AddWorkItemQueueRequest", "value": _1.AddWorkItemQueueRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "addworkitemqueue", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.AddWorkItemQueueResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.workitemqueue];
                }
            });
        });
    };
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.UpdateWorkItemQueue = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new UpdateWorkItemQueueDefaults(), options);
                        message = _1.UpdateWorkItemQueueRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.UpdateWorkItemQueueRequest", "value": _1.UpdateWorkItemQueueRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "updateworkitemqueue", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = _1.UpdateWorkItemQueueResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.workitemqueue];
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.DeleteWorkItemQueue = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new DeleteWorkItemQueueDefaults(), options);
                        message = _1.DeleteWorkItemQueueRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.DeleteWorkItemQueueRequest", "value": _1.DeleteWorkItemQueueRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "deleteworkitemqueue", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
     ...
     */
    openiap.prototype.CustomCommand = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = base_1.CustomCommandResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.result];
     ...
     * @returns
     */
    openiap.prototype.CreateWorkflowInstance = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = queues_1.CreateWorkflowInstanceResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
     ...
     * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
     */
    openiap.prototype.EnsureCustomer = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = base_1.EnsureCustomerResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result];
     ...
     */
    openiap.prototype.InvokeOpenRPA = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new InvokeOpenRPADefaults(), options);
                        if (typeof opt.payload == "object" && opt.payload != null)
                            opt.payload = JSON.stringify(opt.payload);
                        message = queues_1.InvokeOpenRPARequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.InvokeOpenRPA", "value": queues_1.InvokeOpenRPARequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "invokeopenrpa", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = queues_1.InvokeOpenRPAResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, JSON.parse(result.payload)];
                }
            });
        });
    };
     ...
     * @returns void
    */
    openiap.prototype.StartAgent = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!this.connected)
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new Startagentidefaults(), options);
                        message = agent_1.StartAgentRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.StartAgent", "value": agent_1.StartAgentRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "startagent", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.StartAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
                }
            });
        });
     ...
     * @returns void
    */
    openiap.prototype.StopAgent = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new Stopagentidefaults(), options);
                        message = agent_1.StopAgentRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.StopAgent", "value": agent_1.StopAgentRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "stopagent", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.StopAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
    ...
    */
    openiap.prototype.GetAgentLog = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new GetAgentLogDefaults(), options);
                        message = agent_1.GetAgentLogRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.GetAgentLog", "value": agent_1.GetAgentLogRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "getagentlog", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.GetAgentLogResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.result];
    ...
    */
    openiap.prototype.GetAgentPods = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new GetAgentPodsDefaults(), options);
                        message = agent_1.GetAgentPodsRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.GetAgentPods", "value": agent_1.GetAgentPodsRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "getagentpods", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.GetAgentPodsResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        if (result.results != null && result.results != "")
     ...
     * @returns void
    */
    openiap.prototype.DeleteAgentPod = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new DeleteAgentPodDefaults(), options);
                        message = agent_1.DeleteAgentPodRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.DeleteAgentPod", "value": agent_1.DeleteAgentPodRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "deleteagentpod", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.DeleteAgentPodResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
     ...
     * @returns void
    */
    openiap.prototype.DeleteAgent = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new DeleteAgentDefaults(), options);
                        message = agent_1.DeleteAgentRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.DeleteAgent", "value": agent_1.DeleteAgentRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "deleteagent", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = agent_1.DeleteAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
    ...
    openiap.prototype.GetIndexes = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new GetIndexesDefaults(), options);
                        message = base_1.GetIndexesRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.GetIndexes", "value": base_1.GetIndexesRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "getindexes", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _b = (_a = base_1.GetIndexesResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        if (result.results != null && result.results != "")
    ...
    */
    openiap.prototype.CreateIndex = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new CreateIndexDefaults(), options);
                        message = base_1.CreateIndexRequest.create(opt);
                        if (typeof message.index == "object")
                            message.index = this.stringify(message.index);
                        if (typeof message.options == "object")
                            message.options = this.stringify(message.options);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.CreateIndex", "value": base_1.CreateIndexRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "createindex", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = base_1.CreateIndexResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/, result.result];
     ...
     * @returns void
    */
    openiap.prototype.DropIndex = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new DropIndexDefaults(), options);
                        message = base_1.DropIndexRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.DropIndex", "value": base_1.DropIndexRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "dropindex", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = base_1.DropIndexResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
     ...
     * @returns void
    */
    openiap.prototype.DeletePackage = function (options, priority, span) {
        if (priority === void 0) { priority = 2; }
        if (span === void 0) { span = null; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, traceId, spanId, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!this.signedin)
                            throw new Error("Not signed in to server");
                        opt = Object.assign(new DeletePackageDefaults(), options);
                        message = base_1.DeletePackageRequest.create(opt);
                        data = any_1.Any.create({ type_url: "type.googleapis.com/openiap.DeletePackage", "value": base_1.DeletePackageRequest.encode(message).finish() });
                        payload = base_1.Envelope.create({ command: "deletepackage", data: data, jwt: opt.jwt });
                        payload.priority = priority;
                        _a = apiinstrumentation_1.apiinstrumentation.GetTraceSpanId(span), traceId = _a[0], spanId = _a[1];
                        payload.spanid = spanId;
                        payload.traceid = traceId;
                        _c = (_b = base_1.DeletePackageResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _c.apply(_b, [(_d.sent()).data.value]);
                        return [2 /*return*/];
...
var AddWorkItemQueueDefaults = /** @class */ (function () {
    function AddWorkItemQueueDefaults() {
        this.skiprole = false;
    }
    return AddWorkItemQueueDefaults;
}());
var UpdateWorkItemQueueDefaults = /** @class */ (function () {
    function UpdateWorkItemQueueDefaults() {
        this.skiprole = true;
        this.purge = false;
    }
    return UpdateWorkItemQueueDefaults;
}());
var DeleteWorkItemQueueDefaults = /** @class */ (function () {
    function DeleteWorkItemQueueDefaults() {
        this.purge = false;
    }
    return DeleteWorkItemQueueDefaults;
}());
var InvokeOpenRPADefaults = /** @class */ (function () {
    function InvokeOpenRPADefaults() {
        this.rpc = true;
    }
    return InvokeOpenRPADefaults;
}());
var Startagentidefaults = /** @class */ (function () {
    function Startagentidefaults() {
    }
    return Startagentidefaults;
}());
var Stopagentidefaults = /** @class */ (function () {
    function Stopagentidefaults() {
    }
    return Stopagentidefaults;
}());
var GetAgentLogDefaults = /** @class */ (function () {
    function GetAgentLogDefaults() {
    }
    return GetAgentLogDefaults;
}());
var GetAgentPodsDefaults = /** @class */ (function () {
    function GetAgentPodsDefaults() {
        this.stats = false;
    }
    return GetAgentPodsDefaults;
}());
var DeleteAgentPodDefaults = /** @class */ (function () {
    function DeleteAgentPodDefaults() {
    }
    return DeleteAgentPodDefaults;
}());
var DeleteAgentDefaults = /** @class */ (function () {
    function DeleteAgentDefaults() {
    }
    return DeleteAgentDefaults;
}());
var CreateIndexDefaults = /** @class */ (function () {
    function CreateIndexDefaults() {
    }
    return CreateIndexDefaults;
}());
var DropIndexDefaults = /** @class */ (function () {
    function DropIndexDefaults() {
    }
    return DropIndexDefaults;
}());
var DeletePackageDefaults = /** @class */ (function () {
    function DeletePackageDefaults() {
    }
    return DeletePackageDefaults;
}());
var GetIndexesDefaults = /** @class */ (function () {
    function GetIndexesDefaults() {
    }
    return GetIndexesDefaults;
}());
