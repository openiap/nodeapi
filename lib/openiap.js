            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Signin({ username: _username, password: _password, ping: config_1.config.DoPing, agent: this.agent })];
                    case 1:
                        reply = _a.sent();
                        if (this.loginresolve != null) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.Signin({ jwt: _jwt, ping: config_1.config.DoPing, agent: this.agent })];
                    case 3:
                        reply = _a.sent();
                        if (this.loginresolve != null) {
                            this.loginresolve(reply.user);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        message = base_1.SigninRequest.create({ agent: opt.agent, username: opt.username, password: opt.password, ping: opt.ping, longtoken: opt.longtoken });
