...
var openiap = /** @class */ (function (_super) {
    ...
    openiap.prototype.cliOnMessage = function (client, message) {
        return __awaiter(this, void 0, void 0, function () {
            var rt, we_1, document, we, data, user_1, jwt, reply2, error_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 15];
                    case 7:
                        if (!this.queues[we.queuename]) return [3 /*break*/, 14];
                        _a.label = 8;
                    case 8:
                        _a.trys.push([8, 12, , 13]);
                        return [4 /*yield*/, this.queues[we.queuename](we, data, user_1, jwt)];
                    case 9:
                        reply2 = _a.sent();
                        if (!(reply2 != null && we.replyto != null && we.replyto != "")) return [3 /*break*/, 11];
 ...
 * ```
 */
    openiap.prototype.Distinct = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.AddWorkItemQueue = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = _1.AddWorkItemQueueResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.UpdateWorkItemQueue = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = _1.UpdateWorkItemQueueResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/, result.workitemqueue];
    ...
    * @param priority Message priority, the higher the number the higher the priority. Default is 2, 3 or higher requeires updates to server configuration
    */
    openiap.prototype.DeleteWorkItemQueue = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload;
            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = base_1.EnsureCustomerResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/, result];
     ...
     */
    openiap.prototype.InvokeOpenRPA = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = queues_1.InvokeOpenRPAResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
     ...
     * @returns void
    */
    openiap.prototype.StartAgent = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!this.connected)
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.StartAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
                }
            });
        });
     ...
     * @returns void
    */
    openiap.prototype.StopAgent = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.StopAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
    ...
    */
    openiap.prototype.GetAgentLog = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.GetAgentLogResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/, result.result];
    ...
    */
    openiap.prototype.GetAgentPods = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.GetAgentPodsResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        if (result.results != null && result.results != "")
     ...
     * @returns void
    */
    openiap.prototype.DeleteAgentPod = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.DeleteAgentPodResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
     ...
     * @returns void
    */
    openiap.prototype.DeleteAgent = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = agent_1.DeleteAgentResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
    ...
    openiap.prototype.GetIndexes = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
    ...
    */
    openiap.prototype.CreateIndex = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, result, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = base_1.CreateIndexResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        result = _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/, result.result];
     ...
     * @returns void
    */
    openiap.prototype.DropIndex = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = base_1.DropIndexResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
     ...
     * @returns void
    */
    openiap.prototype.DeletePackage = function (options, priority) {
        if (priority === void 0) { priority = 2; }
        return __awaiter(this, void 0, void 0, function () {
            var opt, message, data, payload, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        payload.priority = priority;
                        _b = (_a = base_1.DeletePackageResponse).decode;
                        return [4 /*yield*/, protowrap_1.protowrap.RPC(this.client, payload)];
                    case 1:
                        _b.apply(_a, [(_c.sent()).data.value]);
                        return [2 /*return*/];
