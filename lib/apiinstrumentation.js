...
var apiinstrumentation = /** @class */ (function () {
    ...
    apiinstrumentation.With = function (spanname, traceId, spanId, traceFlags, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var Context = apiinstrumentation.setparent(traceId, spanId, traceFlags);
    ...
    apiinstrumentation.GetTraceSpanId = function (span) {
        if (span == null)
            return [null, null];
        ...
        if (ctx == null)
            return [null, null];
        // @ts-ignore
        var traceId = ctx.traceId, spanId = ctx.spanId;
        return [traceId, spanId];
    };
    return apiinstrumentation;
}());
exports.apiinstrumentation = apiinstrumentation;
//# sourceMappingURL=apiinstrumentation.js.map