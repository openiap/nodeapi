...
var protowrap = /** @class */ (function () {
    ...
    protowrap.DownloadFile = function (client, id, filename, highWaterMark) {
        var _this = this;
    ...
    protowrap.UploadFile = function (client, filename, jwt) {
        var packdata = any_1.Any.create({ "typeUrl": "openiap.UploadRequest", "value": base_1.UploadRequest.encode(base_1.UploadRequest.create({ filename: filename })).finish() });
