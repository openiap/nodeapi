...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, col, count, result, old, indexname, indexes, indexes, indexes, ensureresult, wiqresult, wiqresult, pods, logs, pods, idx1, idx2, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 40:
                                    ...
                                    return [3 /*break*/, 89];
                                case 41:
                                    if (!(str == "undefined")) return [3 /*break*/, 42];
                                    c.GetElement("");
                                    return [3 /*break*/, 89];
                                case 42:
                                    if (!str.startsWith("spam")) return [3 /*break*/, 43];
                                ...
                                case 48:
                                    error_2 = _d.sent();
                                    return [3 /*break*/, 49];
                                case 49: return [4 /*yield*/, c.CreateCollection({ collectionname: "testcollection", expireAfterSeconds: 20, timeseries: { timeField: "_created", metaField: "metadata" } })];
                                case 50:
                                    _d.sent();
                                ...
                                case 70:
                                    _d.sent();
                                    _d.label = 71;
                                case 71: return [3 /*break*/, 89];
                                case 72:
                                    if (!(str == "agent2")) return [3 /*break*/, 74];
