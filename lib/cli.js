...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, count, result, old, ensureresult, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    _loop_1 = function () {
                        var result_1, result_2, i_1, mainStartTime, skipresults, results_1, mainElapsedTime, u_1, result_3, result_4, i_2, mainStartTime, skipresults, results_2, mainElapsedTime, u_2, result_5, result_6, result_7, results_3, i, results_4, i, results_5, i, i, rid_1, error_2, startTime, result_8, filepath_1, filename_1, _b, _c, error_3;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    _d.trys.push([0, 62, 63, 64]);
                                ...
                                case 36:
                                    ...
                                    return [3 /*break*/, 61];
                                case 37:
                                    if (!(str == "undefined")) return [3 /*break*/, 38];
                                    c.GetElement("");
                                    return [3 /*break*/, 61];
                                case 38:
                                    if (!str.startsWith("spam")) return [3 /*break*/, 39];
                                ...
                                case 44:
                                    error_2 = _d.sent();
                                    return [3 /*break*/, 45];
                                case 45: return [4 /*yield*/, c.CreateCollection({ collectionname: "testcollection", timeseries: { timeField: "timestamp", metaField: "metadata" } })];
                                case 46:
                                    _d.sent();
                                    return [3 /*break*/, 61];
                                case 47:
                                    if (!(str == "ec")) return [3 /*break*/, 49];
                                    return [4 /*yield*/, c.EnsureCustomer({ customer: base_1.Customer.create({ name: "testcustomer" }), ensureas: "641f36c88ecd2bbbbd3a52b3" })];
                                case 48:
                                    ensureresult = _d.sent();
                                    console.log(ensureresult);
                                    return [3 /*break*/, 61];
                                case 49:
                                    if (!(str == "c")) return [3 /*break*/, 51];
