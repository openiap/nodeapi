    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _loop_1 = function () {
                        var result_1, result_2, i_1, mainStartTime, skipresults, results_1, mainElapsedTime, u_1, result_3, result_4, i_2, mainStartTime, skipresults, results_2, mainElapsedTime, u_2, result_5, result_6, results_3, i, results_4, i, results_5, i, i, rid_1, error_2, startTime, result_7, filepath_1, filename_1, _b, _c, error_3;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    _d.trys.push([0, 60, 61, 62]);
                                ...
                                case 42:
                                    error_2 = _d.sent();
                                    return [3 /*break*/, 43];
                                case 43: return [4 /*yield*/, c.CreateCollection({ collectionname: "testcollection", timeseries: { timeField: "timestamp", metaField: "metadata" } })];
                                case 44:
                                    _d.sent();
                                    return [3 /*break*/, 59];
                                case 45:
                                    if (!(str == "ec")) return [3 /*break*/, 47];
