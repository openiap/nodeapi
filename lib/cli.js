...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, count, result, old, ensureresult, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    _loop_1 = function () {
                        var result_1, result_2, i_1, mainStartTime, skipresults, results, mainElapsedTime, u_1, result_3, result_4, i_2, mainStartTime, skipresults, results, mainElapsedTime, u_2, result_5, result_6, results, i, results, i, results, i, i, rid_1, error_2, startTime, result_7, filepath_1, filename_1, _b, _c, error_3;
