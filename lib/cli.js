...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, count, result, old, ensureresult, wiqresult, wiqresult, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 55:
                                    ...
                                    return [4 /*yield*/, c.UpdateWorkItemQueue({ workitemqueue: workitems_1.WorkItemQueue.create({ name: "testq1" }) })];
                                case 56:
                                    wiqresult = _d.sent();
                                    console.log(wiqresult);
                                    return [3 /*break*/, 71];
