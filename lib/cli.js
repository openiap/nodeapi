...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, count, result, old, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
