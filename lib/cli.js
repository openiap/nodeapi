...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var c, error_1, _loop_1, payload, str, data2, data, data2, u, items, items, count, result, old, ensureresult, wiqresult, wiqresult, pods, logs, pods, idx1, idx2, Readable, rs, filename, constresult, filepath, filename, items, wi1, filepath, filename, wi2, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 48:
                                    error_2 = _d.sent();
                                    return [3 /*break*/, 49];
                                case 49: return [4 /*yield*/, c.CreateCollection({ collectionname: "testcollection", timeseries: { timeField: "timestamp", metaField: "metadata" } })];
                                case 50:
                                    _d.sent();
                                    return [3 /*break*/, 83];
                                case 51:
                                    if (!(str == "ec")) return [3 /*break*/, 53];
                                ...
                                case 66:
                                    if (!(str == "agent2")) return [3 /*break*/, 68];
