...
var protowrap = require('./protowrap').protowrap;
var readline = require('readline');
var _a = require("process"), input = _a.stdin, output = _a.stdout;
var clientType = require("./client").clientType;
...
var files = [
    ...
    "/home/allan/Pictures/ml-creator-1.png",
    "/home/allan/Pictures/ml-creator-2.png",
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 47:
                                    ...
                                    return [4 /*yield*/, protowrap.RPC(c.client, payload)];
                                case 48:
                                    result = _d.sent();
                                        ...
                                        return function (string, encoding, fd) {
                                            try {
                                                ...
                                                if (string && string != "\r\n" && string.length > 4) {
                                                    ...
                                                    protowrap.sendMesssag(c.client, { rid: rid_1, command: "stream", data: packdata }, "", true);
                                                }
                                            }
                                            catch (error) {
                                ...
                                case 81:
                                    ...
                                    rs = new Readable;
                                    rs._read = function () { };
                                    return [4 /*yield*/, protowrap.CreateStream(c.client, rs, payload)];
                                case 82:
                                    _d.sent();
                                ...
                                case 85:
                                    ...
                                    return [4 /*yield*/, protowrap.DownloadFile(c.client, "63cd46fcd97779605c3e8c6a", "fs.files", filename, "", config_1.config.SendFileHighWaterMark)];
                                case 86:
                                    result_8 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 87:
                                    if (!(str == "f2")) return [3 /*break*/, 89];
                                    cleanup();
                                    // filename = nextfilename();
                                    // let name = path.basename(filename);
                                    filename = "download.png";
                                    startTime = new Date().getTime();
                                    return [4 /*yield*/, protowrap.DownloadFile(c.client, "6608157a60ad2717a5be980e", "mail.files", filename, "", config_1.config.SendFileHighWaterMark)];
                                case 88:
                                    result_9 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 89:
                                    if (!(str == "f3")) return [3 /*break*/, 91];
                                    cleanup();
                                    // filename = nextfilename();
                                    // let name = path.basename(filename);
                                    filename = "download.png";
                                    startTime = new Date().getTime();
                                    return [4 /*yield*/, protowrap.DownloadFile(c.client, "", "mail.files", "message 18e8f93e40000067ac", "", config_1.config.SendFileHighWaterMark)];
                                case 90:
                                    result_10 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 91:
                                    if (!(str == "pp")) return [3 /*break*/, 93];
