                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 85:
                                    ...
                                    return [4 /*yield*/, protowrap_1.protowrap.DownloadFile(c.client, "63cd46fcd97779605c3e8c6a", "fs.files", filename, "", config_1.config.SendFileHighWaterMark)];
                                case 86:
                                    result_8 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 87:
                                    ...
                                    filename = "download.png";
                                    startTime = new Date().getTime();
                                    return [4 /*yield*/, protowrap_1.protowrap.DownloadFile(c.client, "6608157a60ad2717a5be980e", "mail.files", filename, "", config_1.config.SendFileHighWaterMark)];
                                case 88:
                                    result_9 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 89:
                                    ...
                                    filename = "download.png";
                                    startTime = new Date().getTime();
                                    return [4 /*yield*/, protowrap_1.protowrap.DownloadFile(c.client, "", "mail.files", "message 18e8f93e40000067ac", "", config_1.config.SendFileHighWaterMark)];
                                case 90:
                                    result_10 = _d.sent();
                                    return [3 /*break*/, 97];
                                case 91:
